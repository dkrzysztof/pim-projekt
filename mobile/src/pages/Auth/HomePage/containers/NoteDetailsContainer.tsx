...
const NoteDetailsContainer: React.FC<{}> = () => {
				...
				<View style={styles.contentContainer}>
					...
					<View style={styles.descriptionContainer}>
						<Text style={styles.descriptionText}>
							Lorem ipsum dolor sit amet, consect etur adipiscing elit. Maecenas non ex accumsan nisl
							gravida sodales eu a eros. Maecenas urna eros, laoreet ut orci vel, dignissim posuere risus.
							Ut eleifend arcu a purus luctus, quis luctus mauris fringilla.
						</Text>
						<View style={styles.thinUnderline} />
